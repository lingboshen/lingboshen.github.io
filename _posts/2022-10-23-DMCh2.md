...
$$\begin{eqnarray}
\label{eqp9}
x^{T}_{i}(y-X\hat{\beta})&=&\langlex^{T}_{i},y-X\hat{\beta}\rangle=0
\end{eqnarray}$$
...
5.  $$X=\left[\begin{array}{cc}
    ...
    $$\begin{eqnarray}
    \bm{P_{x_{1}}}&=&P_{X}\\
    \bm{P_{x_{1}}}P_{X}&=&P_{X}\bm{P_{x_{1}}}=\bm{P_{x_{1}}}\\
    \bm{M_{x_{1}}}&=&M_{X}\\
    \bm{M_{x_{1}}}M_{X}&=&M_{X}\bm{M_{x_{1}}}=M_{X}
    \end{eqnarray}$$
