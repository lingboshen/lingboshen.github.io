...
$$\begin{eqnarray}
    ...
    \end{eqnarray}$$
 Let $X=\bm{Z}^{T}Z$, and
    $X\sim N(0,\bm{Z}^{T}\bm{Z})$. Therefore,
    

$$\begin{eqnarray}
    Z^{T}PZ&=&X^{T}(\bm{Z}^{T}\bm{Z})^{-1}X
    \end{eqnarray}$$
...
$$\begin{eqnarray}
\hat{\beta}_{2}&=&\frac{X_{2}^{T}\bm{M}_{1}\bm{y}}{X_{2}^{T}\bm{M}_{1}X_{2}}\\
Var(\hat{\beta}_{2})&=&\sigma^{2}\left(X_{2}^{T}\bm{M}_{1}X_{2}\right)^{-1}
\end{eqnarray}$$
...
$$\begin{eqnarray}
\label{eq7}
z_{\beta_{2}}&=&\frac{X_{2}^{T}\bm{M}_{1}\bm{y}}{\sigma\left(X_{2}^{T}\bm{M}_{1}X_{2}\right)^{1/2}}\\
\label{eq8}
&=&\frac{X_{2}^{T}\bm{M}_{1}\bm{u}}{\sigma\left(X_{2}^{T}\bm{M}_{1}X_{2}\right)^{1/2}}\sim N(0,1)
\end{eqnarray}$$
...
$$\begin{eqnarray}
\nonumber
t_{\beta_{2}}&=&\frac{X_{2}^{T}\bm{M}_{1}\bm{y}}{s\left(X_{2}^{T}\bm{M}_{1}X_{2}\right)^{1/2}}\\
\nonumber
&=&\frac{X_{2}^{T}\bm{M}_{1}\bm{y}}{\frac{s}{\sigma}\sigma\left(X_{2}^{T}\bm{M}_{1}X_{2}\right)^{1/2}}\\
\nonumber
...
\end{eqnarray}$$
 where
$\bm{\varepsilon}\equiv\bm{u}/\sigma\sim N(0, \bm{1})$. The second
...
$\bm{\varepsilon}^{T}P_{\bm{M}_{1}\bm{X}_{2}}\bm{\varepsilon}$, it
...
$$\begin{eqnarray}
\label{eq26}
\y=\x\be_{1}+\bm{Z}\bm{\gamma}+\bu&,&\bu\sim N(0,\sigma^{2}I)
\end{eqnarray}$$
 The null hypothesis is $H_{0}:\bm{\gamma}=0$ and it
...
$$\begin{eqnarray}
\label{eq21}
t_{\beta_{2}}&=&\left(\frac{\bm{y}^{T}\bm{M_{X}\bm{y}}}{n-k}\right)^{-1/2}\frac{n^{-1/2}X_{2}^{T}\bm{M}_{1}\bm{y}}{\left(n^{-1}X_{2}^{T}\bm{M}_{1}X_{2}\right)^{1/2}}
\end{eqnarray}$$
...
$$\begin{eqnarray}
\label{eq22}
t_{\beta_{2}}&=&\frac{n^{-1/2}X_{2}^{T}\bm{M}_{1}\bm{u}}{\sigma_{0}\left(n^{-1}X_{2}^{T}\bm{M}_{1}X_{2}\right)^{1/2}}
\end{eqnarray}$$
...
$$\begin{eqnarray}
E(X_{2}^{T}\bm{M}_{1}\bm{u}\bm{u}^{T}\bm{M}_{1}X_{2}|\bm{X})&=&\sigma_{0}^{2}X_{2}^{T}\bm{M}_{1}X_{2}
\end{eqnarray}$$
...
$$\begin{eqnarray}
\bm{v}&\sim&N\left(0, \lim_{n\to\infty}\frac{1}{n}\sum_{t=1}^{n}Var(u_{t}\bm{X}_{t}^{T})\right)=N\left(0, \lim_{n\to\infty}\frac{1}{n}\sum_{t=1}^{n}E(u_{t}^{2}\bm{X}_{t}^{T}\bm{X}_{t})\right)
\end{eqnarray}$$
